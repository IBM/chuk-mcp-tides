...
- **18 tools** across 6 categories (stations, predictions, observations, analysis, flood risk, discovery)
...
| **EA Flood Monitoring** | England, Wales, N. Ireland | None | 44 tide gauges |
...
| `TIDES_CONSTITUENTS_DIR` | No | `~/.chuk/tides/constituents` | Constituent storage path |
